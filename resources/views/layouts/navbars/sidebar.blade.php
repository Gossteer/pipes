        ...
        <ul class="nav">
                ...
                <li
                    ...
                    <div class="collapse show" id="laravelExample">
                        <ul class="nav">
                            ...
                            <li class="nav-item{{ $activePage == 'recordings-admin' ? ' active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.recordings.admin') }}">
                                    <i class="material-icons">store</i>
                                    <span class="sidebar-normal">Заказы</span>
                                </a>
                            </li>
            ...
            @else
                ...
                <li
                    ...
                    <div class="collapse show" id="laravelExample">
                        <ul class="nav">
                            <li class="nav-item{{ $activePage == 'profile.recordings-customer' ? ' active' : '' }}">
                                <a class="nav-link" href="{{ route('profile.recordings.customer') }}">
                                    <i class="material-icons">store</i>
                                    <span class="sidebar-normal">Заказы</span>
                                </a>
                            </li>
